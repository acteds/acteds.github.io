...
官方网站：[Apache Seata](https://seata.apache.org/zh-cn/)，Demo1：[apache/incubator-seata-sample](https://github.com/apache/incubator-seata-samples/tree/master)，Demo2：[Kerry2019/seata-tcc-demo](https://github.com/Kerry2019/seata-tcc-demo)。
...
`@LocalTCC` 注解并不是强制性的，它用于明确表示一个类实现了本地 TCC 事务。如果你的类中已经使用了 `@TwoPhaseBusinessAction` 注解来标记 TCC 事务的各个阶段方法，Seata 也可以识别并处理这些方法。
